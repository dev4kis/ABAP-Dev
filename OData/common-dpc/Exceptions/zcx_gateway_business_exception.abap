CLASS zcx_gateway_business_exception DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    CLASS-METHODS raise_business_exception
      IMPORTING
...
CLASS ZCX_GATEWAY_BUSINESS_EXCEPTION IMPLEMENTATION.
  ...
  METHOD raise_business_exception.
    ...
    RAISE EXCEPTION TYPE
      zcx_gateway_business_exception
      EXPORTING
